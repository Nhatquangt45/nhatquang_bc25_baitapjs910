...
function layThongTinNhanVien(isChecking = true) {
  ...
  isValid &=
    ...
    validation.kiemTraDoDaiKyTu(
      taiKhoan,
      "tbTKNV",
      "(*) vui lòng nhập tài khoản có từ 4 - 6 ký tự",
      4,
      6
    ) &&
    validation.kiemTraSo(
      taiKhoan,
      "tbTKNV",
      "(*) vui lòng nhập tài khoản là ký tự số"
    );
  ...
  isValid &=
    validation.kiemTraRong(emailNV, "tbEmail", "(*) vui lòng nhập email") &&
    validation.kiemTraEmail(
      emailNV,
      "tbEmail",
      "(*) vui lòng nhập email đúng định đạng"
    );
  ...
  isValid &=
    ...
    validation.kiemTraPass(
      matKhau,
      "tbMatKhau",
      "(*) vui lòng nhập mật khẩu có chứa ít nhất 1 ký tự số, 1 ký tự in hoa, 1 ký tự đặc biệt"
    );
